...
tagfrom = "436dbaf27ac9eea7bb97f04631f729534905af23";
tagto  = "76fa816ccf1833c8766f9b6c79eb5b47a7f81687";
...
ff = open("C:\Projects\Release#C\TestRelease_8.0.6\spoolPyFull.log", "w")
for a in diffs_file:
    ff.writelines(str(a) + '\n')
ff.close()

# f = open("C:\Projects\Release#C\TestRelease_8.0.6\spoolPy.log", "w")
# for x in diffs_file:
#     x = x.split('\t')
#     if x[0][0:1] == 'R':
#         for i in x:
